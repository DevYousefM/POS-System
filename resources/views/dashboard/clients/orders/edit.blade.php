...
@section('title')
    <title>@lang('site.editOrderTitle')</title>
@endsection
@section('css')
    <!-- Font Awesome -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@lang('site.editOrderTitle')</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dash.index') }}">@lang('site.home')</a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{ route('dash.clients.index') }}">@lang('site.orders')</a></li>
                            <li class="breadcrumb-item active">@lang('site.editOrderTitle')</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="orderCreate">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                @foreach($category->products as $product)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button
                                                                class="btn {{in_array($product->id,$order->products->pluck("id")->toArray()) ? "brn-default disabled" : "btn-success"}} add-product-btn"
                    ...
                    <div>
                        <div class="card card-info card-outline p-1">
                            ...
                            <form method="POST"
                                  action="{{route("dash.clients.orders.update",["client"=>$order->client->id,"order"=> $order])}}">
                                @csrf
                                @method("put")
                                <div class="card-header">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="products[{{$product->id}}][quantity]"
                                                       data-price="{{$product->sell_price}}" min="1"
                                ...
                                <button class="btn btn-info btn-block disabled edit-order" id="add-order"
